...
// === Paste your Google Drive links below (any form: /view, ?id=, uc?id=) ===
const rawVideos = [
...
const initialVideos = rawVideos.map(driveToEmbed);
...
export default function FuturisticPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b12] text-white" dir={dir}>
      ...
      {/* Reels slider (pure CSS) */}
      <section className="mx-auto max-w-7xl px-4 py-14">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl md:text-3xl font-bold">{t.portfolioTitle}</h2>
        </div>

        {/* Responsive container: compact on desktop, fluid on mobile */}
        <div className="mx-auto w-full 
            max-w-[86vw] sm:max-w-[420px] md:max-w-[440px] lg:max-w-[460px] xl:max-w-[480px]">
          <PureCssSlider items={videos} />
        </div>
      </section>
